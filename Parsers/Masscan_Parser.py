            ...
            if port.attributes['portid'].value != 0:    # Disregard host check scan
                ...
                if len(serviceList) == 0:   # For blank services
                    ...
                    for service in serviceList:
                        svcName = service.attributes['name'].value
                        # Various services need be passed to tshark to be correctly interpreted
                        if str.lower(svcName) in masscan_controller.SERVICE_PASS_TO_PCAP:
